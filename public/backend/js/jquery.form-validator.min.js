...
!function(a,b)
{
    ...
    {
        return b(a)
    }):"object"==typeof exports?module.exports=b(require("jquery")):b(jQuery)}(this,function(a)
        {
            !function(a,b)
            {
                "use strict";function c(b)
                {
                    b&&"custom"===b.errorMessagePosition&&"function"==typeof
                        b.errorMessageCustom&&(a.formUtils.warn("Use of deprecated function errorMessageCustom, use config.submitErrorMessageCallback " +
                        "instead"),b.submitErrorMessageCallback=function(a,c)
                    {
                ...
                function d(b)
                {
                    if(b.errorMessagePosition&&"object"==typeof b.errorMessagePosition){
                        ...
                        var c=b.errorMessagePosition;b.errorMessagePosition="top",b.submitErrorMessageCallback=function()
                        {
                            return c
                        }
                    }
                ...
                function e(b)
                {
                    ...
                    c.length&&a.formUtils.warn('Detected use of attribute "data-validation-if-checked" which is deprecated. ' +
                        'Use "data-validation-depends-on" provided by module "logic"'),c.on("beforeValidation",function()
                    {
                        var c=a(this),
                ...
                a.fn.validateForm=function(b,c)
                {
                    ...
                    {
                        f||(f=a("form")),c(g),d(g),e(f)})}(a),function(a)
                        {
                            "use strict";
                            var b={resolveErrorMessage:function(a,b,c,d,e)
                            {
                                var f=d.validationErrorMsgAttribute+"-"+c.replace("validate_",""),g=a.attr(f);
                                return g||(g=a.attr(d.validationErrorMsgAttribute),
                                    g||(g="function"!=typeof b.errorMessageKey?e[b.errorMessageKey]:e[b.errorMessageKey(d)],g||(g=b.errorMessage))),g
                            ...
                            },applyInputErrorStyling:function(a,b)
                            {
                                ...
                                },setInlineMessage:function(b,c,d)
                                {
                                    ...
                                    if(f)
                                        a.formUtils.warn("Using deprecated element reference "+f.id),g=a(f),i();
                                ...
                                {
                                    var f='<div class="{errorMessageClass} alert alert-danger">' +
                        ...
                        }(a),function(a,b,c)
                        {
                            ...
                            var d=0;a.fn.validateOnBlur=function(b,c)
                            {
                                ...
                                }),c.validateCheckboxRadioOnClick&&this.find("input[type=checkbox][data-validation]," +
                                    "input[type=radio][data-validation]").bind("click.validation",function()
                                {
